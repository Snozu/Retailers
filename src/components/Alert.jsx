...
function SummaryAlerts({ total, pending, approved, rejected }) {
  return (
    <div className="flex flex-wrap items-center gap-4">
      ...
      <div className="w-44 h-24 bg-black text-white rounded-md flex flex-col items-center justify-center gap-1 p-2">
      ...
      <div className="w-44 h-24 bg-white border border-gray-300 rounded-md flex flex-col items-center justify-center gap-1 p-2">
      ...
      <div className="w-44 h-24 bg-white border border-green-400 rounded-md flex flex-col items-center justify-center gap-1 p-2">
      ...
      <div className="w-44 h-24 bg-white border border-red-400 rounded-md flex flex-col items-center justify-center gap-1 p-2">
